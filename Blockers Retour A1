...
,pbl.comment as last_active_blocker_comment
,datediff(day, '1899-12-30', pbl.updated_on) as last_active_blocker_updated_on
...
left join wkda_retail_publishing_blocker.publishing_blocker as pbl on pbl.retail_ad_id = ra.id and pbl.status = 'ACTIVE'
left join wkda_retail_publishing_blocker.publishing_blocker as pbl2 on pbl2.retail_ad_id = pbl.retail_ad_id and pbl2.created_on > pbl.created_on
